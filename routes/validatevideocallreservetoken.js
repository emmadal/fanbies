...
validatevideocallreservetoken.post('/', (req, res) => {
    ...
    function validateToken() {
        return new Promise((resolve, reject) => {
            connection.query(`SELECT * from ${process.env.DB_PREFIX}reservecallbookings WHERE tokenkey = ? AND status = ?`, [hashtoken, 'created'] , (error, results) => {
    ...
    function getuserbyid(id) {
        return new Promise((resolve, reject) => {
            const col = ['username','name','picture','profession'];
