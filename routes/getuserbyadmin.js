...
getuser.post('/', (req, res) => { 
    ...
    function userDetails(tokenid){
        const columns = ['id','email','username','name','picture','extra_talent','active','primary_talent','secondary_talent','bio','mediaUrl','shoutrate','available_slot','twitter_id','fb_id','tik_id','linkedin_id','ig_id','usertype', 'featured','profession','callrate'];
