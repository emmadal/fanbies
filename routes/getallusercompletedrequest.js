...
const getallusercompletedrequest = express.Router();
...
/**
 * Get all completed or ended shoutouts
 */
getallusercompletedrequest.post('/', (req, res) => {
...
module.exports = getallusercompletedrequest;
