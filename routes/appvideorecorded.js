...
const apprecordedvideo = express.Router();
...
apprecordedvideo.post('/', upload.single('file'), (req, res) => {
    ...
    function S3Storage() {
        ...
        Promise.all(s3Promise).then(data =>{
          ...
          .then(()=>{
            updateShoutoutStatus(request_id);
    ...
    function updateShoutoutStatus(id){
        return new Promise((resolve,reject) => {
    ...
    /**
     * 
     * @param {the reg id token of device } value 
    */
...
module.exports = apprecordedvideo;